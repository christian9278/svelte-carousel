    ...
    <div class="sc-carousel__content-container">
        {#if arrows}
            <slot name="prev" showPrevPage={methods.showPrevPage}>
                <div
                    class="sc-carousel__arrow-container sc-carousel__arrow-container-prev"
                >
                    <Arrow
                        direction="prev"
        ...
        {#if arrows}
            <slot name="next" showNextPage={methods.showNextPage}>
                <div
                    class="sc-carousel__arrow-container sc-carousel__arrow-container-next"
                >
                    <Arrow
                        direction="next"
                        disabled={!infinite &&
...
<style>
    ...
    .sc-carousel__arrow-container-next {
        right: 5px;
    }
    .sc-carousel__arrow-container-prev {
        left: 5px;
    }
